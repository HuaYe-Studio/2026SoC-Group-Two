...
public class Mental_UI : MonoBehaviour
{
    ...
    {
        if (currentMentalValue > 2 / 3 * maxMentalValue)
        {
        ...
        else if (currentMentalValue >= 1 / 3 * maxMentalValue && currentMentalValue <= 2 / 3 * maxMentalValue)
        {
            mental_icon_good.gameObject.SetActive(false);
            mental_icon_bad.gameObject.SetActive(false);
            mental_icon_worse.gameObject.SetActive(true);
        }
        else if (currentMentalValue < 1 / 3 * maxMentalValue)
        {
            mental_icon_good.gameObject.SetActive(false);
